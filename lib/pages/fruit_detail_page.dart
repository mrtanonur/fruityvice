      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            customRow(
              "order: ",
              provider.fruits[provider.fruitIndex!].order,
            ),
            customRow(
              "genus: ",
              provider.fruits[provider.fruitIndex!].genus,
            ),
            Row(
              children: [
                const Text(
                ...
                Column(
                  ...
                  children: [
                    ...
                    customRow("carbohydrates: ", "${nutritions.carbohydrates}"),
...
Widget customRow(String leftText, String rightText) {
  return Row(
    children: [
      Text(leftText, style: const TextStyle(fontWeight: FontWeight.w700)),
      Text(rightText),
    ],
  );
}
